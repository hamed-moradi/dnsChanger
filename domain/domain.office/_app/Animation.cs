...
namespace domain.office._app {
    public class Animation {
        internal NotifyIconUtility _parent;
        ...
        public Animation() {
            _animRefreshTimer.Elapsed += _animTimer_Tick;
            _animFrameTimer.Elapsed += _animFrameTimer_Tick;
        }
        ...
        public void BeginWithOverlay(Icon baseIcon, Image[] images, int interval, int framesToFade) {
            ...
            _animFramesToFade = (int)(Math.Max(1, framesToFade) * interval / _animRefreshTimer.Interval);
